...
public class Main{
    public static void main(String[] args){
        ...
        try {
         ...
         System.out.println(name+"さんと私、どちらかが先攻、どちらかが後攻となって、1~30まで交互に数字を数えて先に30を言った方が負け！\n簡単なゲームだね！");
        try {
            Thread.sleep(3000);
        } catch(InterruptedException e){
            e.printStackTrace();
        ...
        PrayerAction Prayer = new PrayerAction(name);
        ComputerAction CPU = new ComputerAction();
